...
* The original package name 'com.cs.sigm.person-service' is invalid and this project uses 'com.cs.sigm.person_service' instead.
...
```
$ docker run --rm -p 8080:8080 person-service:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/person-service
```
